            ...
            <Grid container justifyContent="center" >
                <Grid item container xs={11} sm={10} md={9} lg={8} spacing={2}>
                    ...
                    <div className="grey7 size2 font2">
                        ...
                        <div className="mt-4">All orders will be dispatched from our warehouse within 3 business days. Amazing Sewing does not take responsibility for any untracked parcels that go missing. We are not responsible for delays, lost or damaged shipments or orders sent to incorrect, invalid addresses or correct addresses. Amazing Sewing will help as much as possible to trace a missing parcel, however if untracked shipping is selected, it is the customer’s responsibility to follow up with the carrier. Amazing Sewing is not responsible for refunds of shipping costs in the event of delayed shipping due to product availability.</div>
