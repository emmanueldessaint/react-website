      ...
      <Container className="pt-15 singleProduct">
        ...
        <Grid container justifyContent="center" spacing={6}>
          <Grid
            ...
            sm={11}
            md={6}
            className="dispositionImageProduct"
          >
            <div className="productComputer">
              {product.images.map((image) => (
                <div key={image.id}>
                  <Grid item xs={12} onClick={() => changeImage(image.url)}>
                    <img
                      className="cursorPointer switchImg m-1 shadowProduct1"
            ...
            <div className="m-1">
              <img
                className="imageOneProduct shadowProduct1 imgAppearTransition"
                src={window.location.origin + `/images/${defaultImage}`}
              />
            </div>
            <div className="flex">
              {product.images.map((image) => (
                <div key={image.id}>
                  <div onClick={() => changeImage(image.url)}>
                    <img
                      className="switchImgMobile productMobile cursorPointer"
                      src={window.location.origin + `/images/${image.url}`}
                    ></img>
                  </div>
                </div>
          ...
          <Grid item xs={12} sm={10} md={5}>
            ...
            <div className="flexBetween mt-7">
              ...
              <span
                ...
                className="font5 underlined grey8 cursorPointer scrollSmooth"
              >
              ...
              <Grid container justifyContent="center">
                <Grid item xs={11} sm={6}>
                  <div className=" addSubstractCart flex">
                    <div className="verticalAlign quantityProduct size2 height27 lightShadowCard2">
                      {quantityProduct}
                    </div>
                    <ColorButton
                      style={{
                ...
                <Grid item xs={11} sm={6}>
                  ...
                  >
                    <div
                      className="bgSuccess opacity9 bgBlue pl-5 pr-5 font2 p-1  bold200 textWhite borderRadius5 boxShadowButton verticalAlign"
                      onClose={handleClose}
                      severity="success"
                    >
                      <span>
        ...
        <Box className="pt-10 productComputer" sx={{ width: "100%" }}>
          ...
          <TabPanel value={value} index={1}>
            <div>
              ...
              effectiveness of the accessories. That's why we work with
              qualified designers to make the most convenient and lovely items.
              <br></br>
              <br></br>
                    ...
                    {product.avg !== undefined ? (
                      <div className="flex">
                        ...
                        <div className="height50 ml-2">
                          ...
                          <div className="font2 size08 grey7">
                  ...
                  <div className="">
                    <div>
                      <div className="flex">
                        ...
                        />
                        <div className="bold800 width20 ml-2 grey7">
                          ({numberOfStars.fiveStars})
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex">
                        ...
                        <Line
                          percent={
                            (numberOfStars.twoStars / numberOfStars.nbOfStars) *
                            100
                          }
                          strokeWidth="1"
                          strokeColor="orange"
                    ...
                    <div>
                      <div className="flex">
                        ...
                        <Line
                          percent={
                            (numberOfStars.oneStar / numberOfStars.nbOfStars) *
                            100
                          }
                          strokeWidth="1"
                          strokeColor="orange"
            ...
            {writeReviews === true && (
              <div className="mb-3">
                <div className="flexBetween">
                  ...
                  />
                  <div
                    className="mr-4 cursorPointer hoverUnderlined grey7"
                    onClick={handleReviews}
                  >
                    close
                  </div>
              ...
              <AccordionDetails className="flexColumn">
                <div className="mlw-1 mb-4 ">
                  ...
                  <div className="mt-4">
                    <div>
                      <div className="flex">
                        <div className="bold800 width20 mr-2 grey7">
                          ({numberOfStars.fiveStars})
                        </div>
                        <Line
                          percent={
                ...
                {currentItems &&
                  currentItems.map((review, index) => (
                    <div
                      key={index}
                      className="lightShadowCard2 p-3 mb-5 minWidth500 bgWhite"
                    >
                      <Grid container className="flexBetween">
                        <Grid item sm={10} xs={12}>
                          <div className="mb-2 flex">
                            ...
                            <div className="font5 bold600 grey8">
                              {review.title}
                            </div>
                            <br />
                            <div className="ml-3 bold500 size08 font07 grey6">
                              {review.created_at}
                            </div>
                          </div>
                          <div>
                            <div className="font2 grey6 width100">
                              {review.description}
                            </div>
                          </div>
                        </Grid>
        ...
        <Grid className="pt-7" container justifyContent="center">
          <Grid item xs={11} md={11}>
            <div className="mt-10 mb-3">
              ...
              <span className="flexCenter font8 size7 mt-3 bold600 bestSellers opacity9 letterSpacing2">
                Our customers also like ...
              </span>
            </div>
            {isLoaded && (
              <div className="">
                <Carousel responsive={bestSellersCarousel} infinite={true}>
                  {bestSellers.map((item) => (
                    <div
                      className="cardProductCarousel lightShadowCard2"
                      key={item.id}
                    >
                      <Link
                      ...
                      >
                        <img
                          className="imageProductCarousel"
                          src={
                        ...
                        <div className="nameProduct font11 letterSpacing1 size3 grey7 flexCenter">
                          {item.name}
                        </div>
                        ...
                        <div className="priceProduct font2 grey8 letterSpacing2 mt-2 ml-3 pb-1 opacity9">
