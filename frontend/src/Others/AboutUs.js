...
export default function AboutUs() {
    ...
    return (
        <div className="pt-13">
            ...
            <Grid container justifyContent="center" className="menuQuality">
                <Grid item container xs={12} md={10} spacing={2}>
                    <Grid item xs={4}><img className="imageProduct" src="https://fabric-store.imgix.net/blog/DIYs/2021/Table-Setting/DIY-Table-Setting-Detail.jpg?auto=format&fp-x=0.5&fp-y=0.5&ixlib=php-2.1.1&q=85&w=900" alt="parisfabrics sewing quality"/></Grid>
                    <Grid item xs={4}><img className="imageProduct" src="https://i.shgcdn.com/462b5a50-2a99-490d-8c2d-da1175573e81/-/format/auto/-/preview/3000x3000/-/quality/lighter/" alt="parisfabrics sewing quality"/></Grid>
                    <Grid item xs={4}><img className="imageProduct" src="https://i.shgcdn.com/9c21b692-7d8c-431c-a64b-2ba4f1c47121/-/format/auto/-/preview/3000x3000/-/quality/lighter/" alt="parisfabrics sewing quality"/></Grid>
